...
> ⚠️ **2026-08-11 校准**:整方向已调整为"系统策划为主 + 活动/商业化为辅",作品集从 1v1 boss 战 demo 升级为 4 块结构(见下方"系统策划作品集启动")。本条目作为技术参考保留:UE BT/AI 是 1v1 boss 战 demo 重新定位为"战斗系统设计 demo"时仍可参考的引擎栈。
...
### demo 设计启动 (2026-07-27 21:19, 最终版 → 2026-08-03 调整 → 2026-08-11 校准)
Type: project

**⚠️ 2026-08-03 调整**:
- 1v1 boss 战 demo 暂缓(不砍),等想好具体设计再回来
- 新活跃项目:**三消回合制肉鸽 demo**(自己玩,非作品集,不进"3D 战斗策划"求职方向)
  - 框架一(1 角色 3 技能)+ 肉鸽 a+c(局内 build + 局内地图/事件)
  - 策略性主要落在肉鸽玩法(build / 路径 / 强化方向)
  - W1 终版定稿:2026-08-03 凌晨
  - 当前进度:W1 完成,准备 W2 范围(棋盘/行动点/角色属性/技能池/敌方/肉鸽颗粒度)
  - 单源真相:`D:\portfolio\demo-idea\idea-终版.md`

(原 7-27 21:19 决策,作为 1v1 boss 战 暂缓前的技术参考保留)
...
### 系统策划作品集启动 (2026-08-11 01:40 方向校准, 覆盖 7-27 21:19 → 8-3 调整)
Type: project
...
**节奏**: 10-12h/周(工作日 30-60min + 周末 3-4h)— 沿用 7-27 21:19
**公司电脑规则**(7-28 标记,不变):❌ 不做 UE / BT / 作品集相关具体动作;✅ 可做非 UE 方向代码学习 + MH 运营
**Mavis 角色**: 跟 7-27 一致,只给"现在做这步要查的东西",不主动出学习路径
**下一步**(2026-08-12 公司): 决定系统思维练习的**选品 + 选系统**

**单源真相**:
- 详细规划:`D:\portfolio\game-design-portfolio\portfolio-plan-2026-08-11.md`(106 行)
